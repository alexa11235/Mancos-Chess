            ...
            if (match.bye) {
              ...
              return (
                <tr key={index} className="bg-gray-900/30">
                  ...
                  <td className="py-3 px-1 md:py-4 md:px-4 text-gray-600 italic text-[10px] md:text-sm truncate">Sin oponente</td>
              ...
              <tr key={index} className="hover:bg-gray-800/20 transition-colors">
                ...
                <td className="py-3 px-1 md:py-4 md:px-4">
                  <div className="flex items-center gap-1 md:gap-3 overflow-hidden">
                    <button 
                      ...
                      className="w-6 h-6 md:w-8 md:h-8 rounded border border-gray-500 flex items-center justify-center text-[10px] md:text-xs font-bold text-white hover:bg-gray-700 transition-colors shrink-0"
                    >
                ...
                <td className="py-3 px-1 md:py-4 md:px-2 text-center">
                  <div className="flex items-center justify-center h-full">
                    <span className={
                      match.resultado 
                        ? "inline-flex items-center justify-center w-14 md:w-20 text-center text-green-400 font-bold font-mono text-[11px] md:text-base bg-green-400/10 py-1 rounded border border-green-400/30" 
                        : "inline-flex items-center justify-center w-14 md:w-20 text-center text-gray-500 font-mono text-[10px] md:text-sm py-1"
                    }>
                      {match.resultado 
